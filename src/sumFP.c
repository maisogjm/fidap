...
main (int argc, char *argv[])
{
    ...
    if ((argc!=2) && (argc!=3)) {
        printf("sumFP: need input floating point image file.\n");
        printf("       Will return the sum of all voxels in this file.\n");
    ...
    num_vox = num_voxX4/4;
/*
    printf("sumFP: Number of voxels = %d\n",num_vox);
*/
    ...
    if (imgin == NULL) {
        printf("sumFP: failed to malloc for imgin.\n");
        exit(4);
    }
