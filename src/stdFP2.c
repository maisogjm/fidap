...
main (int argc, char *argv[])
{
    /* 06.07.95 : JM Maisog : Sums voxels in a floating point image.
       ...
       10.20.95: JMM : Modified varFP2 to generate stdFP2.  Program
    ...
    if ((argc!=2) && (argc!=3)) {
        printf("stdFP2: need input floating point image file.\n");
    ...
    if (imgin == NULL) {
        printf("stdFP2: failed to malloc for imgin.\n");
        exit(4);
    }
