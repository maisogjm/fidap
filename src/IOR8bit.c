...
{
    /* 10.17.03 : JM Maisog : Performs IOR operation on 8-bit maps.     */
    ...
    if (argc < 4) {
        printf("IOR8bit: need input files (at least 2) and output file.\n");
        exit(1);
    }
    ...
    /* **************************************************************** */
    /* WRITE OUT UNSIGNED 8 BIT TO OUTPUT FILE, IOR CLOSE FILES.        */
