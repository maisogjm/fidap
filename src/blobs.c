...
*/
{
    ...
    if (argc < 10) {
        printf("blobs: Need name of input .hdr file, input statistical\n");
        printf("       image file, input 8-bit mask image, output cluster mask\n");
        printf("       file, output zscore cluster file, output probability\n");
        printf("       cluster file, output text file, zscore threshold for\n");
        printf("       generating clusters, and probability threshold for\n");
        printf("       significance.\n");
    ...
    if (image==NULL) {
        printf("blobs: unable to malloc for image.\n");
        exit(3);
    }
    ...
    if(num_read_in!=num_vox) {
        printf("blobs: %d voxels read in; should have been %d.\n",
                                                num_read_in,num_vox);
        exit(5);
    }
    ...
    if (mask==NULL) {
        printf("blobs: unable to malloc for mask.\n");
        exit(6);
    }
    ...
    if(num_wrote_out!=num_vox) {
        printf("blobs: %d voxels wrote out; should have been %d.\n",
