...
main(int argc, char *argv[])
{
    ...
    char dummy[MAXSTR];         /* Dummy pointer for counting number of entries     */
                            /* in a text file.                                  */
    ...
    char outfilename[MAXSTR];   /* Array to contain name of output text file.       */
...
/*  ALLOCATE MEMORY FOR img_name; THEN READ IN NAMES OF INPUT IMAGE FILES.      */
    ...
    img_name = char_malloc3(num_dep_var,num_rows,MAXSTR);
