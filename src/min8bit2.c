...
{
    /* 04.25.94 : JM Maisog
	Returns the minimum of a signed 8-bit binary file.	*/
    ...
    if (argc < 2) {
	printf("min8bit2: need name of 8-bit input file.\n");
	exit(1);
    }
    ...
    if (imgin == NULL) {
	printf("min8bit2: failed to malloc for imgin.\n");
	exit(4);
    }
