...
main (int argc, char *argv[])
{
    ...
    FILE *fIN, *fOUT;
    unsigned char *imgin1, *imgin2, *imgin3;
    ...
    if (argc != 9) {
        printf("byte3_to_gray: need 3 input files, 3 numbers to represent each, 8-bit mask, and output file.\n");
    ...
    if ((fIN=fopen(argv[1],"r")) == NULL) {
        printf("byte3_to_gray: can't open %s\n",argv[1]);
        exit(2);
    }
    ...
    num_vox = num_voxX4;
    printf("byte3_to_gray: Number of voxels = %d\n",num_vox);
